...
export class SigninSignupComponent {
  ...
  constructor(private _formBuilder: FormBuilder, private _router: Router, private _loginService: LoginSignupService) { }
  ...
  onSubmitSignUp() {
    ...
    this._loginService.userRegister(this.user_dto).subscribe(data => {
      alert("User Register Successfull ☺");
      this._router.navigateByUrl('/sign-in');
    })
  }
  onSubmitSignIn() {
    this._loginService.authLogin(this.signInFormValue.userEmail, this.signInFormValue.userPassword).subscribe({
      next: (data: any) => {
        this.user_data = data;
